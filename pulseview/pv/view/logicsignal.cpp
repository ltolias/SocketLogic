	...
	for (int32_t type_id : trig_types) {
		...
		switch (type_id) {
			case SR_TRIGGER_ZERO:
				type = TriggerMatchType::ZERO;
				break;
			case SR_TRIGGER_ONE:
				type = TriggerMatchType::ONE;
				break;
			case SR_TRIGGER_OVER:
				type = TriggerMatchType::OVER;
				break;
			case SR_TRIGGER_UNDER:
				type = TriggerMatchType::UNDER;
				break;
			case SR_TRIGGER_RISING:
				type = TriggerMatchType::RISING;
				break;
			case SR_TRIGGER_FALLING:
				type = TriggerMatchType::FALLING;
				break;
			case SR_TRIGGER_EDGE:
				type = TriggerMatchType::EDGE;
				break;
		}
