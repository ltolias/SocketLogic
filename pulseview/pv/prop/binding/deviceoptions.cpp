	...
	configurable_(configurable)
{
	...
	for (auto entry : configurable->config_keys(ConfigKey::DEVICE_OPTIONS)) {
		...
		case SR_CONF_LIMIT_FRAMES:
			bind_int(name, "", pair<int64_t, int64_t>(-1, 100), get, set);
			break;
		...
		case SR_CONF_COUPLING:
			//bind_enum(name, key, capabilities, get, set, print_couple);
			bind_enum(name, gvar_list, get, set, print_gvariant);
			break;
		case SR_CONF_DEVICE_MODE:
			//bind_enum(name, key, capabilities, get, set, print_cont);
			bind_enum(name, gvar_list, get, set, print_gvariant);
			break;
		...
		case SR_CONF_TRIGGER_SOURCE:
			//bind_enum(name, key, capabilities, get, set, print_tsource);
			bind_enum(name, gvar_list, get, set, print_gvariant);
			break;
		case SR_CONF_TRIGGER_SLOPE:
			//bind_enum(name, key, capabilities, get, set, print_tslope);
			bind_enum(name, gvar_list, get, set, print_gvariant);
			break;
