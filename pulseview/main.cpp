...
int main(int argc, char *argv[])
{
	...
	while (1) {
		...
		case 'l':
		{
			...
			const sigrok::LogLevel * type;
			switch (loglevel) {
				case SR_LOG_NONE:
					type = sigrok::LogLevel::NONE;
					break;
				case SR_LOG_WARN:
					type = sigrok::LogLevel::WARN;
					break;
				case SR_LOG_INFO:
					type = sigrok::LogLevel::INFO;
					break;
				case SR_LOG_DBG:
					type = sigrok::LogLevel::DBG;
					break;
				case SR_LOG_SPEW:
					type = sigrok::LogLevel::SPEW;
					break;
			}
			context->set_log_level(type);
